    ...
    >
      <div className="flex justify-between items-end mb-8 border-b border-red-500/20 pb-4 relative">
        ...
        <div>
          ...
          <p className="text-sm text-red-500/50 mt-1 font-mono tracking-widest uppercase">Comparing Primary Architecture vs. Experimental LLM Track</p>
        </div>
            ...
            <div className="border border-emerald-500/20 bg-emerald-500/5 p-5 rounded-xl flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-white/60 leading-relaxed">
                  Successfully handled massive class imbalance via <code>class_weight='balanced'</code>. Highly optimized and deployed on Port 5000.
                </p>
              </div>
            </div>
          </div>
        ...
        <GlowCard glowColor="purple" className="p-8 border-purple-500/20 bg-[#060606]/80 backdrop-blur-xl relative overflow-hidden flex flex-col h-full">
          ...
          <div className="grid grid-cols-2 gap-6 mb-8 relative z-10">
            ...
            <div className="bg-black/60 border border-white/10 p-5 rounded-xl shadow-[inset_0_0_20px_rgba(255,255,255,0.02)] flex flex-col justify-center">
              <div className="text-xs text-white/40 uppercase tracking-widest font-mono mb-1">Latency (P99)</div>
              <div className="text-3xl font-mono font-bold text-white flex items-baseline gap-1">
                1,850 <span className="text-sm text-white/30">ms</span>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-4 relative z-10 flex-1">
            <div className="border border-white/10 bg-black/40 p-5 rounded-xl backdrop-blur-sm">
              ...
              <ul className="text-sm text-white/50 space-y-3 font-mono">
                <li className="flex justify-between"><span className="text-white/30">Pre-trained</span> <span className="text-cyan-400">microsoft/deberta-v3</span></li>
                <li className="flex justify-between"><span className="text-white/30">Parameters</span> <span className="text-cyan-400">141 Million</span></li>
                <li className="flex justify-between"><span className="text-white/30">Hardware</span> <span className="text-cyan-400">RTX 3050 (8GB VRAM)</span></li>
                <li className="flex justify-between"><span className="text-white/30">Microservice</span> <span className="text-cyan-400">Flask Port 5001</span></li>
              </ul>
            </div>
            
            <div className="border border-amber-500/20 bg-amber-500/5 p-5 rounded-xl flex items-start gap-4">
              <AlertTriangle className="w-6 h-6 text-amber-500 flex-shrink-0" />
              <div>
                <h4 className="text-xs font-bold text-amber-500 uppercase tracking-widest mb-1">Long-Tail Pruning Applied</h4>
                <p className="text-sm text-white/60 leading-relaxed">
                  LLM failed to generalize minority classes (0% F1). Required dropping classes with &lt;100 support to define certified operational scope and pass the 75% threshold.
                </p>
              </div>
            </div>
          </div>
