...
const SNIPPETS = [
  {
    ...
    lang: "Python",
    color: "#ef4444",
    description: "The core Flask endpoint that runs a company description through TF-IDF vectorization and dual LinearSVC classification, returning GECS taxonomy codes.",
    lines: [
      L(["@", C.decorator], ["app.route", C.func], ["(", C.plain], ["'/api/predict'", C.string], [", methods=", C.plain], ["['POST']", C.string], [")", C.plain]),
      L(["def ", C.keyword], ["predict", C.func], ["():", C.plain]),
      L(["    ", C.plain], ["# Parse input", C.comment]),
      L(["    data = request.", C.plain], ["get_json", C.func], ["()", C.plain]),
      L(["    text = data.", C.plain], ["get", C.func], ["(", C.plain], ["'text'", C.string], [", ", C.plain], ["''", C.string], [")", C.plain]),
      L(["", C.plain]),
      L(["    ", C.plain], ["# Vectorize → Sparse CSR", C.comment]),
      L(["    X = vectorizer.", C.plain], ["transform", C.func], ["([text])", C.plain]),
      L(["", C.plain]),
      L(["    ", C.plain], ["# Task 1: Industry (145 classes)", C.comment]),
      L(["    t1_label = clf_t1.", C.plain], ["predict", C.func], ["(X)[", C.plain], ["0", C.number], ["]", C.plain]),
      L(["    t1_conf  = ", C.plain], ["get_confidence", C.func], ["(clf_t1, X)[", C.plain], ["0", C.number], ["]", C.plain]),
      L(["    mstar_code = idx_to_code_t1[str(t1_label)]", C.plain]),
      L(["", C.plain]),
      L(["    ", C.plain], ["# Task 2: Subindustry (407 classes)", C.comment]),
      L(["    t2_label = clf_t2.", C.plain], ["predict", C.func], ["(X)[", C.plain], ["0", C.number], ["]", C.plain]),
      L(["    gecs_code  = idx_to_code_t2[str(t2_label)]", C.plain]),
      L(["", C.plain]),
      L(["    ", C.plain], ["return ", C.keyword], ["jsonify", C.func], ["({", C.plain]),
      L(["        ", C.plain], ["'mstar_code'", C.string], [": mstar_code,", C.plain]),
      L(["        ", C.plain], ["'mstar_label'", C.string], [": GECS_T1[mstar_code],", C.plain]),
      L(["        ", C.plain], ["'confidence_t1'", C.string], [": t1_conf,", C.plain]),
      L(["        ", C.plain], ["'alternatives_t1'", C.string], [": alts_t1,", C.plain]),
      L(["    ", C.plain], ["})", C.plain]),
    ],
  },
  {
  ...
  },
  {
    ...
    lines: [
      ...
      L(["", C.plain]),
      L(["# ", C.comment], ["Vectorize with 50,000 bigram features", C.comment]),
      ...
      L(["    max_features=", C.plain], ["50000", C.number]),
      L([")", C.plain]),
      L(["", C.plain]),
      ...
      L(["# ", C.comment], ["Macro F1: 43% → 86.82%", C.comment]),
