...
# Run at the same time as task1_features.py and task2_features.py - no conflicts
...
def main():
    ...
    # word cloud - only runs if wordcloud package is installed
    try:
    ...
    body = [
        ...
        *t2_findings,
        ...
        "- Use text fields and class distribution info to guide feature engineering.",
    ]
