...
# Run at the same time as dashboard.py and task2_features.py - no conflicts
# Usage: python task1_features.py
...
def main():
    ensure_folders()
    print("task 1 feature engineering starting...\n")
    ...
    # Step 3 - keyword features related to industry categories
    industry_keywords = [
    ...
    # Step 5 - TF-IDF on combined text (all text columns merged)
    ...
    body = [
        ...
        "",
        "## Next step",
        "- Task 1 features are ready in outputs/features/task1/ - notify whoever is running model_ready.py",
    ]
