...
# Run at the same time as Tserennad and Srilaxmi - no conflicts
# Usage: python vishal_task2_features.py
...
def main():
    ensure_folders()
    print("=== Vishal Task 2 Feature Engineering ===\n")
    ...
    body = [
        ...
        "",
        "## Next step",
        "- Tell Subasree: Task 2 features are ready in outputs/features/task2/",
    ]
    save_markdown_report(FINDINGS_PATH / "task2_feature_summary.md", "Task 2 Feature Engineering Summary", body)

    print("\nTask 2 feature engineering completed successfully.")
